...
const ResumeCard = ({ isBlank, name }) => {
  return (
    <div className="flex flex-col items-center">
      {isBlank ? (
        <div className="w-56 h-[18rem] border-2 border-gray-400 flex items-center justify-center text-4xl font-bold text-gray-400 transition duration-200">
          +
        </div>
      ) : (
...
const MobileResumeRow = ({ name }) => (
  <div className="flex items-center justify-between bg-white px-4 py-3 rounded-lg shadow-sm border  transition duration-200">
...
const ResumeDashboard = () => {
 ...
 const handleOpenResume = (resumeName) => {
    alert(`Opening ${resumeName}`);
    // here you could navigate to /resume/${resumeName}
  };
  return (
