...
const TemplateCard = () => (
  <div className="bg-white shadow-lg rounded-lg p-6 w-full max-w-sm mx-auto">
    ...
    <div className="mb-4">
      ...
      <p className="text-gray-600 text-sm">University<br />Aug 2022 | Location</p>
      <p className="text-gray-600 text-sm mt-1">College<br />Aug 2022 | Location</p>
    </div>

    <div className="mb-4">
      <h4 className="font-semibold mb-1">Experience</h4>
      <p className="text-gray-600 text-sm">
        Company · Product Designer<br />
        Aug 2022 - Present<br />
    ...
    <div className="mb-4">
      ...
      <p className="text-gray-600 text-sm">
        Design: User Interviews, Affinity Diagramming, Card Sorting, Information Architecture, A/B Testing, Design Handoff<br />
