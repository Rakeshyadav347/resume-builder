  ...
  return (
    <>
      <div className="flex flex-col items-center text-center mt-10 gap-3">
        {/* Heading */}
        <h1 className="text-3xl font-bold">Essential Career Guides</h1>
        <p className="text-gray-600 md:max-w-xl md:px-20 px-4">
          Find an online library of free career resources, job search
          strategies, and interview prep guides
        </p>
