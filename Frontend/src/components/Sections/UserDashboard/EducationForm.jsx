...
export default function EducationForm() {
  ...
  function onSubmit(data) {
    updateResumeData("education", [...(resumeData.education || []), data]);
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="max-w-3xl mx-auto p-6 bg-white shadow-lg rounded-lg">
          ...
          <p className="text-gray-600 mb-6">
            ...
            input at least your degree, courses name, and duration.
          </p>
          ...
          {/* Add Button */}
          <button className="flex items-center justify-center gap-2 bg-blue-500 text-white px-4 py-2 rounded-md shadow-md hover:bg-blue-600 transition mb-6">
